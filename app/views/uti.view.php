<div class="row m-0 p-0 justify-content-end position-relative w-100">
    <aside class="col-8 col-md-3 p-0 z-3 overflow-y-scroll aside-uti">
        <header class="w-100">
            <div class="border-bottom border-secondary-subtle w-100 d-flex ps-3 align-items-center" style="height: 10vh;">
                <span class="text-decoration-none d-flex align-items-center" id="uti-home">
                    <img src="<?php echo $APP_URL . "public/assets/images/uti-bird.png" ?>" alt="logo-depa-copan" style="width: 60px;height: 50px;">
        ...
        <div class="h-auto w-100 px-2">
            ...
            <ul class="position-relative start-0 bottom-0 border-0 list-unstyled d-none" id="dropdown-list">
                <li class="mb-2 aside-links-uti rounded dropdow-item"><a href="<?php echo $APP_URL ?>statistics/dashboard" class="text-decoration-none p-2 w-100 h-100 d-inline-block rounded"><i class="fa-solid fa-chart-simple me-2"></i>Sistema de estadística educativa</a></li>
                <li class="mb-2 aside-links-uti rounded dropdow-item"><a href="<?php echo $APP_URL ?>sace/onlineapplications" class="text-decoration-none p-2 w-100 h-100 d-inline-block rounded"><i class="fa-solid fa-toolbox me-2"></i>Herramientas Docentes</a></li>
                <li class="mb-2 aside-links-uti rounded dropdow-item"><a href="<?php echo $APP_URL ?>teacher/update" class="text-decoration-none p-2 w-100 h-100 d-inline-block rounded"><i class="fa-solid fa-calendar me-2"></i></i>Actualización Docente</a></li>
                <li class="mb-2 aside-links-uti rounded dropdow-item"><a href="<?php echo $APP_URL ?>operations" class="text-decoration-none p-2 w-100 h-100 d-inline-block rounded"><i class="fa-solid fa-users-gear me-2"></i>Unidades y Subdirecciones</a></li>
            ...
            <ul class="list-unstyled p-0">
                ...
                <li class="mb-2 aside-links-uti rounded" id="btn-identity"><span href="" class="text-decoration-none p-2 w-100 h-100 d-inline-block rounded"><i class="fa-solid fa-fingerprint me-2"></i>Identidad</span></li>
